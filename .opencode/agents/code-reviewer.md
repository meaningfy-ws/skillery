---
description: 'Reviews code for quality, security, architecture conformance, and test coverage before
  a PR. Use proactively after implementation, before opening a PR. Read-only — does
  not modify code. Thin wrapper — the review criteria live in the meaningfy-code-review
  skill.
...
...
tools: {bash: true, glob: true, grep: true, read: true}
permission: {edit: deny}
color: yellow
...
skills: [meaningfy-code-review, cosmic-python]
---
