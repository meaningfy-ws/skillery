# vault-curation Specification

## Purpose
Curating a vault without breaking it: promoting staged notes after a kind check, and tidying only
after an explicit yes, with every move made through the Obsidian CLI.
## Requirements
