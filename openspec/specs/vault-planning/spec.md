# vault-planning Specification

## Purpose
Planning and review sessions across year, quarter (OKRs), month and week, with plans kept in one
file per year and objectives that only the owner sets.
## Requirements
