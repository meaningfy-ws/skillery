...
## Purpose
Bootstrapping and checking a personal vault and its tooling on either CLI: the vault files, the
per-CLI permission settings, and the guided setup of Obsidian, sync, memory and connectors.
## Requirements
